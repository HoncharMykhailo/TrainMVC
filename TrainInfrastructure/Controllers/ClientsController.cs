...
namespace TrainInfrastructure.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(DbtrainContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
           ...
           // return View(client);
           return RedirectToAction("Index", "Cargoes", new {id=client.Id,name=client.Id});
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
